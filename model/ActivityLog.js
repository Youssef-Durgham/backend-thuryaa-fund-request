...
const activityLogSchema = new Schema({
  ...
  targetUser: { type: String, required: true }, // The user affected by the action
  userType: { type: String, required: true, enum: ['Admin', 'Customer', 'system'] }, // The type of the target user
